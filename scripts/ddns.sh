...
auth_email="ian@ianmkim.com"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="global"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="1453bb7af659f5ccef6f1879c62d8211c9c3a"                                         # Your API Token or Global API Key
zone_identifier="03238ef6b57fa97e84bbf4a4204dee5d"                                  # Can be found in the "Overview" tab of your domain
record_name="karnak.iankim.dev"                                      # Which record you want to be synced
ttl="3600"                                          # Set the DNS TTL (seconds)
proxy="false"                                       # Set the proxy to true or false
sitename="karnak"                                         # Title of site "Example Site"
